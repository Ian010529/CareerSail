 ...
 *   - jobsdb / jijis / offertoday / hkstp / cyberport / indeed — 香港岗位平台
...
const {
  RECRUITER_REGISTRY: HK_RECRUITERS,
  JobsDBRecruiter,
  JIJISRecruiter,
  OfferTodayRecruiter,
  HKSTPRecruiter,
...
const URL_TYPE_RULES = [
  ...
  { type: 'jobsdb', pattern: /hk\.jobsdb\.com/i },
  { type: 'indeed', pattern: /hk\.indeed\.com/i },
  { type: 'jijis', pattern: /jijis\.org\.hk/i },
  { type: 'offertoday', pattern: /ofhr\.com\.hk/i },
  { type: 'hkstp', pattern: /(hkstp\.org|talentjobseeker\.hkstp\.org)/i },
  { type: 'cyberport', pattern: /cyberport\.hk/i }
];
